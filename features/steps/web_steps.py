...
def step_impl(context, element_name):
    element_id = element_name.lower() + "-btn"
    element = context.driver.find_element(By.ID, element_id)
    element.click()
